...
const FiltrosPage = () => {
    ...
    const options = [
        { value: 'SOL', label: 'PROYECTOS ENERGÉTICOS SOLARES' },
        { value: 'VIENTO', label: 'PROYECTOS ENERGÉTICOS EÓLICOS' },
        { value: 'BIOMASA', label: 'OTROS TIPOS DE PROYECTOS ENERGÉTICOS (BIOMASA)' },
        { value: 'TÉRMICO', label: 'OTROS TIPOS DE PROYECTOS ENERGÉTICOS (TÉRMICO)' },
        { value: 'HIDRICO', label: 'HIDROELÉCTRICAS' },
        { value: 'COLOMBIA', label: 'POZOS PETROLEROS' }
    ];
                ...
                <>
                    {dep ? (
                                ...
                                municipio ? (
                                    <>
                                        <div className='filterMap'>
                                            <iframe src={"https://mercadostech.maps.arcgis.com/apps/dashboards/a6f1d95a3fe84a33b2e41db484e3a0e6#div=" + municipio + "&recurso=" + proyecto} className='content_full_page2' style={{ width: '100%' }}></iframe>
                                        </div>
                        ...
                        (
                            <>
                                <div className='filterMap'>
                                    <iframe src={"https://mercadostech.maps.arcgis.com/apps/dashboards/a6f1d95a3fe84a33b2e41db484e3a0e6#recurso=" + proyecto} className='content_full_page2' style={{ width: '100%' }}></iframe>
                                </div>
                                <div className="filterStats">
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi ea, inventore quos accusantium culpa aliquid fugiat itaque nulla tempore alias? Eius illo accusamus reprehenderit perspiciatis recusandae officiis, omnis est repellendus.</p>
                                </div>
                ...
                {/* {
                    proyecto ? (
                        ...
                        <>
                            {
                                municipio ? (
                                    <>
                                        <div className='filterMap'>
                                            <iframe src={"https://mercadostech.maps.arcgis.com/apps/dashboards/a6f1d95a3fe84a33b2e41db484e3a0e6#div=" + municipio} className='content_full_page2' style={{ width: '100%', height: '100%' }}></iframe>
                                        </div>
                                        <div className="filterStats">
                                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi ea, inventore quos accusantium culpa aliquid fugiat itaque nulla tempore alias? Eius illo accusamus reprehenderit perspiciatis recusandae officiis, omnis est repellendus.</p>
                                        </div>
                                    ...
                                    <>
                                        <div className='filterMap'>
                                            <iframe src={"https://mercadostech.maps.arcgis.com/apps/dashboards/a6f1d95a3fe84a33b2e41db484e3a0e6#depto=" + departamento} className='content_full_page2' style={{ width: '100%' }}></iframe>
                                        </div>
                                        <div className="filterStats">
                                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi ea, inventore quos accusantium culpa aliquid fugiat itaque nulla tempore alias? Eius illo accusamus reprehenderit perspiciatis recusandae officiis, omnis est repellendus.</p>
                                        </div>
                        ...
                        (
                            <>
                                <div className='filterMap'>
                                    <iframe src={"https://mercadostech.maps.arcgis.com/apps/dashboards/a6f1d95a3fe84a33b2e41db484e3a0e6#depto="} className='content_full_page2' style={{ width: '100%' }}></iframe>
                                </div>
                                <div className="filterStats">
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi ea, inventore quos accusantium culpa aliquid fugiat itaque nulla tempore alias? Eius illo accusamus reprehenderit perspiciatis recusandae officiis, omnis est repellendus.</p>
                                </div>
