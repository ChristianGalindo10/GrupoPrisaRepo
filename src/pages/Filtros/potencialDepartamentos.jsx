    ...
    return (
        ...
        <div className="page_t1">
            <section className='title_section'>
                <h2 className='title_page'>Potencial energético por departamentos
                </h2>
            </section>
                ...
                <>
                    {departamento ? (
                                ...
                                municipio ? (
                                    <>
                                        <div className='filterMap'>
                                            <iframe src={"https://mercadostech.maps.arcgis.com/apps/dashboards/dd0f5bc8bca643d2b93de4af8bbaa8a7#div=" + municipio + "&capas=" + proyecto} className='content_full_page2' style={{ width: '100%' }}></iframe>
                                        </div>
                                    ...
                                    <>
                                        <div className='filterMap'>
                                            <iframe src={"https://mercadostech.maps.arcgis.com/apps/dashboards/dd0f5bc8bca643d2b93de4af8bbaa8a7#depto=" + departamento + "&capas=" + proyecto } className='content_full_page2' style={{ width: '100%' }}></iframe>
                                        </div>
                                        <div className="filterStats">
                                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi ea, inventore quos accusantium culpa aliquid fugiat itaque nulla tempore alias? Eius illo accusamus reprehenderit perspiciatis recusandae officiis, omnis est repellendus.</p>
                                        </div>
                        ...
                        (
                            <>
                                <div className='filterMap'>
                                    <iframe src={"https://mercadostech.maps.arcgis.com/apps/dashboards/dd0f5bc8bca643d2b93de4af8bbaa8a7#capas=" + proyecto} className='content_full_page2' style={{ width: '100%' }}></iframe>
                                </div>
                                <div className="filterStats">
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi ea, inventore quos accusantium culpa aliquid fugiat itaque nulla tempore alias? Eius illo accusamus reprehenderit perspiciatis recusandae officiis, omnis est repellendus.</p>
                                </div>
